    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="chart-container">
      <div className="reports-table-head">
        ...
        <div className="reports-table-actions">
          <div className="reports-search">
            <Search />
            <Input placeholder="Search…" value={searchQuery} onChange={(e) => { setSearchQuery(e.target.value); setPage(1); }} className="h-8 text-xs" style={{ paddingLeft: "2rem", width: 180 }} />
          </div>
      ...
      <div className="reports-pager">
        ...
        <div className="reports-pager-controls">
          <Button variant="ghost" size="icon" className="h-7 w-7" disabled={page <= 1} onClick={() => setPage(page - 1)}><ChevronLeft /></Button>
          <Button variant="ghost" size="icon" className="h-7 w-7" disabled={page >= totalPages} onClick={() => setPage(page + 1)}><ChevronRight /></Button>
        </div>
      </div>
    </motion.div>
  );
            ...
            <div className="reports-date-field">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="h-9 text-sm" style={{ width: 150, justifyContent: "flex-start" }}>
                    <CalendarIcon style={{ width: 14, height: 14, marginRight: 6 }} />
