              ...
              return (
                <div key={s.name} className="exec-moisture-row">
                  ...
                  <div className="exec-moisture-bar">
                    <div className="exec-moisture-fill" style={{ width: `${pct}%`, backgroundColor: color }} />
                  </div>
                  <span className="exec-moisture-value" style={{ color }}>{s.value}%</span>
                </div>
              );
            })}
          </div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="chart-container">
        <div className="exec-top5-head">
          <div className="exec-top5-titlewrap">
            <Trophy />
            <h3 className="exec-chart-title" style={{ margin: 0 }}>Top 5 Electricity Consumers</h3>
          </div>
